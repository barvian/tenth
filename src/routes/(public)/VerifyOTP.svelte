...
<Grid>
    <fieldset class="lg:col-span-7">
        ...
        <p class="text-lg leading-snug mb-5">Please enter the 6-digit code we sent to {$page.form?.values.email}. <button type="button" on:click={e => dispatch('changeemail', e)}>Change email</button>.</p>
