...
<header class="bg-gradient-to-b from-amber-50 to-amber-100 pt-9 pb-hero overflow-hidden">
    ...
    <div class="overlap">
        <Grid class="relative">
            <svg use:inview class="absolute right-full mr-[2vw] in-view:animate-fly-r" height="87" viewBox="0 0 119 108" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<main class="bg-white bg-noise-white" id="benefits">
    <Grid class="group relative md:py-section items-center">
        <svg use:inview class="absolute right-full bottom-full in-view:animate-fly-r translate-y-1/2" height="87" viewBox="0 0 136 108" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div use:inview class="md:col-span-5 in-view:animate-fly-t">
        ...
        <blockquote use:inview class="in-view:animate-fly-t p-12 pt-14 round-3xl rounded relative lg:col-span-6 lg:col-start-7 bg-dark/5 bg-svg-wave-lightgray">
            <div class="absolute inset-0 border -translate-x-1 -translate-y-1 group-hover:-translate-x-2 group-hover:-translate-y-2 transition-all ease-in-out duration-500 rounded pointer-events-none" role="presentation" />
            <svg class="absolute left-[40%] -top-1 -translate-x-1/2 -translate-y-1/2 group-hover:-translate-y-2/3 transition-all ease-in-out duration-500 h-14" viewBox="0 0 94 79" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <Grid class="relative md:py-section items-center group">
        <div class="md:col-span-5 relative flex justify-end">
            <img use:inview class="rounded-full w-[75%] in-view:animate-fly-r" src="/img/people/1.jpg" alt="" role="presentation" />
            <img use:inview class="rounded-full w-3/5 absolute right-[75%] top-0 in-view:animate-fly-r -translate-y-1/2 group-hover:translate-y-[calc(-50%-theme(space.2))] group-hover:-translate-x-2 transition-transform ease-in-out duration-500" src="/img/people/2.jpg" alt="" role="presentation" />
            <img use:inview class="rounded-full w-2/5 absolute right-[75%] bottom-0 in-view:animate-fly-r translate-y-1/2 group-hover:translate-y-[calc(50%+theme(space.2))] transition-transform ease-in-out duration-500" src="/img/people/3.jpg" alt="" role="presentation" />
        </div>
        <div use:inview class="in-view:animate-fly-t md:col-span-5 md:col-start-7">
        ...
        <svg use:inview class="absolute overflow-visible group top-5 right-0 in-view:animate-fly-l" width="140" viewBox="0 0 232 230" fill="none" xmlns="http://www.w3.org/2000/svg">
            <circle cx="111" cy="111" r="111" fill="url(#paint0_linear_0_1)"/>
            <circle class="transition-transform duration-500 ease-in-out group-hover:translate-x-2 group-hover:translate-y-2" cx="121" cy="119" r="110.25" stroke="black" stroke-width="1" vector-effect="non-scaling-stroke"/>
            <defs>
    ...
    <section class="bg-red-50 bg-noise-white bg-blend-color-burn py-hero">
        <header use:inview class="in-view:animate-fly-t mb-12">
        ...
        <Grid class="lg:gap-x-10 round-3xl items-start">
            <div use:inview class="in-view:animate-fly-t relative md:col-span-6">
                ...
                <details class="rounded bg-white border group relative px-8" bind:open={showingBreakdowns}>
                    <summary class="text-center p-12">
                        ...
                        <span class="block mt-3 text-red-500 text-5xl font-bold text-border">3.1% + 30¢</span>
