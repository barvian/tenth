...
<div class={cls}>
    <div class="group relative w-{width} {type === 'search' ? 'round-full' : 'round-2xl'}">
        ...
        {#if type === 'search'}
            <Search class="w-4 absolute top-1/2 left-5 -translate-y-1/2 -mt-[1px] text-dim peer-focus:text-primary" />
        {:else if icon}
