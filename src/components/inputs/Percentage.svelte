...
<div class="relative inline-block">
    ...
    <label class="relative whitespace-nowrap flex pl-0.5 pr-1 items-baseline text-orange-500 border-current leading-none border-b-4 mb-2 border-dotted pointer-events-none peer-disabled:text-gray-300" for="percentage">
