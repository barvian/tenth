...
<div class="relative inline-block align-middle">
    ...
    <label class="relative whitespace-nowrap flex pl-0.5 pr-1 items-baseline text-bank border-current leading-extra-tight border-b-4 border-dotted pointer-events-none peer-disabled:text-gray-300" for="percentage">
